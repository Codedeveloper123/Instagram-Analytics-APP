...
def getInstagramAccount(params):
    ...
    endpointParams[
        "access_token"
    ] = params['page_access_token']  # tell facebook we want to exchange token
    endpointParams["fields"] = "instagram_accounts"  # access token
...
print(
    response["json_data"]["instagram_accounts"]["data"][0]
